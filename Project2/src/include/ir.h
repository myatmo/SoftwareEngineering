...
class IR: public Election {
	private:
		...
		vector<Ballot*> invalidatedBallots;	// to save all invalidated ballots
	public:
		/**
		...
		*/
		...
		/**
		* @brief getter for the list of invalidated votes in IR election.
		*
		* This function will be used for IR election purposes.
		*
		* @return list of invalidated vote
		*/	
		vector<Ballot*> getInvalidatedBallots();
		void pushInvalidatedBallots(Ballot* ball);
};
}
#endif